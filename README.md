[![GAISD · Governed AI Software Development](https://gaisd.dev/api/badge/readme-block)](https://gaisd.dev)

# The Governed AI Software Development (GAISD) Manifesto
...
**Site:** [gaisd.dev](https://gaisd.dev)
**Sign:** [gaisd.dev/sign](https://gaisd.dev/sign)
...
Not on code, but on **definition**.
Not on output, but on **intent**.
Not on generation, but on **structure**.
...
If you lead, architect, or build software, your endorsement matters.

[**Sign at gaisd.dev/sign →**](https://gaisd.dev/sign)

Sign in with GitHub, Google, or LinkedIn — we verify identity but never post on your behalf.

## Get the Badge

Embed a GAISD badge in your README, personal site, or conference slides. Browse the [badge gallery](https://gaisd.dev/badges) for shields, README blocks, and social cards.

```markdown
![GAISD · Signed](https://gaisd.dev/badge/signed.svg)
```

## Contribute

Translations, typo fixes, and discussion are welcome. See [`CONTRIBUTING.md`](./CONTRIBUTING.md) when available, or open an issue.

## License

This manifesto is published under [Creative Commons Attribution 4.0 International (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/). You may share and adapt it, including for commercial use, with attribution to **The GAISD Manifesto · gaisd.dev**.
